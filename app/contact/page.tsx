...
export default function ContactPage() {
  ...
  return (
    <div>
      {/* Header */}
      <section className="bg-gradient-to-br from-secondary-600 to-primary-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-secondary-100 max-w-2xl mx-auto">
            Have questions? Want to book a consultation? We'd love to hear from
            you!
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">hello@creativesoul.com</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="hair">Hair Services Inquiry</option>
                    <option value="art">Art Purchase Question</option>
